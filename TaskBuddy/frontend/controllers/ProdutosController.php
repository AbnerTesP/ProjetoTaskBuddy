...
class ProdutosController extends Controller
{
    ...
    public function actionIndex($filtro)
    {
        ...
        if (Yii::$app->user->can('verProdutos')) {
            if (Encomendas::find()->where(['idUtilizador' => Perfilutilizador::find()->where(['idUtilizador' => Yii::$app->user->getId()])->one()->id])->andWhere(['finalizada' => 'nao'])->one() == null){
                $encomenda = new Encomendas();
                $encomenda->finalizada = 'nao';
                $encomenda->idUtilizador = Perfilutilizador::find()->where(['idUtilizador' => Yii::$app->user->getId()])->one()->id;
                $encomenda->save();
            }
    ...
    {
        if (Yii::$app->user->can('lerProduto')) {
    ...
    {
        if (Yii::$app->user->can('verProduto')) {
