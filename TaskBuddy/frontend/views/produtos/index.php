...
<?= common\widgets\Alert::widget()?>
    ...
    <?php foreach ($produtos as $produto){?>
                ...
                <div class="el-wrapper">
                    <div class="box-up">
<!--                         <img class="img" /*  echo Html::img(\yii\helpers\BaseUrl::to(Yii::$app->urlManagerBackend->baseUrl.'/produtos/'.$produto->imagem), ['id' => 'imagemProduto']) */?>
 -->                        <div class="img-info">
                                <div class="info-inner">
                                    ...
                                    <div class="box-down">
                                      ...
                                      <?= Html::a('Ver detalhes', ['view', 'id' => $produto->id], ['class' => 'btn btn-primary mt-3']) ?>
